    ...
    <section id="how-it-works" className="py-[100px]">
      <div className="max-w-[1100px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[80px] items-center">
          <div>
            <span className="inline-block text-[12px] font-semibold tracking-[0.12em] uppercase text-violet-400 mb-3.5">How it works</span>
              ...
              <div key={step.title}>
                <div className="flex gap-5 items-start">
                  <div className="flex flex-col items-center">
                    <div className="w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0 font-sora font-bold text-base text-violet-400 border-[1.5px] border-violet-400/30" style={{ background: "rgba(167,139,250,0.12)" }}>
                      {index + 1}
                    </div>
                  ...
                  <div className={`pt-2.5 ${index < steps.length - 1 ? "pb-8" : ""}`}>
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h3 className="font-sora font-bold text-[17px] text-zinc-50">{step.title}</h3>
                    </div>
